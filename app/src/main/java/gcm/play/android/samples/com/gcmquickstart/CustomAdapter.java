...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.list_item_fetch_card, viewGroup, false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public MyViewHolder(View itemView) {
            ...
            icon = (ImageView) itemView.findViewById(R.id.list_item_image2);
            tvDate = (TextView) itemView.findViewById(R.id.tvDateCard);
